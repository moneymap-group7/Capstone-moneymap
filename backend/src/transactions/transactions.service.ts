...
import { SpendCategory, TransactionSource } from "@prisma/client";
...
export class TransactionsService {
  ...
  // Used by inline category editing
  async updateCategoryForUser(transactionId: string, userId: string, spendCategory: SpendCategory) {
    const tid = BigInt(transactionId);
    const uid = BigInt(userId);
