...
- Name: transactions.spec.ts >> transactions page loads
- Location: e2e/transactions.spec.ts:3:1
...
```ts
  ...
  2  | 
  3  | test('transactions page loads', async ({ page }) => {
  ...
  10 | 
  11 |   await page.goto('http://localhost:5173/transactions');
  12 | 
